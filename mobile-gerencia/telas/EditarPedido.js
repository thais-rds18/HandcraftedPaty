...
import { Card, Divider, Layout, useTheme, Text, Button, Icon, ApplicationProvider, Input, Select, SelectItem } from '@ui-kitten/components';
                ...
                <Card style={{ marginBottom: 16 }}>
                    <Layout>
                        ...
                        <View style={styles.view}>
                            ...
                            <Select
                                value={status}
                                selectedIndex={statusOptions.findIndex(option => option.value === status)}
                                onSelect={index => setStatus(statusOptions[index.row].value)}
                                style={styles.select}
                            >
